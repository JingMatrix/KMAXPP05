	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{figure}
				...
				\label{fig:prediction_space_theory}
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{figure}
		...
		\end{column}
	\end{columns}
	Even if the ROC curve shows that our algorithm captures trends well, the prediction space is much more demanding and only shows a few (5) players confidently classified as forwards. For all other players, logistic regression is much less categorical.
\end{frame}