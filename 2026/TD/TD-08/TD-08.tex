...
\begin{document}
	...
	\begin{exercice}
		...
		\end{equation*}
		\begin{enumerate}
			\item Calculer la dérivée $\displaystyle \frac{\partial{L(y^{(i)}, \hat{y}^{(i)})}}{\partial{\hat{y}^{(i)}}}$
			\item En déduire la dérivée $\displaystyle \frac{\partial{e}}{\partial{\hat{y}}}$
			\item Démontrer que $\displaystyle \frac{\partial{e}}{\partial{z}} = \frac{1}{n}\left(\hat{y} - y\right)$
